...
const (
	...
	initDatasetIndex                    = 0
	fakeFeesInPercent                   = 0.15 // percent of amount will be lost for every opened opsition
	differenceBetweenAskAndBidInPercent = 0.15 // in percent, ex : if equal to 1 and price = 100 --> ask = 100.5 and bid = 99.5
)
